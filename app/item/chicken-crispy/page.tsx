...
export default function ChickenCrispy() {
  return (
    <div className="flex bg-white flex-col min-h-screen">
      ...
      <div className="w-full max-w-4xl mx-auto mt-28 rounded-lg overflow-hidden flex flex-col h-screen">
        ...
        <div className="flex-grow p-6 flex flex-col justify-between">
          <h1 className="text-3xl font-bold text-gray-800">Chicken Crispy</h1>
          ...
          <div className="border-t pt-4">
            <Link
              href="/item/chicken-popcorn"
              className="text-blue-500 hover:underline"
            >
              ← Previous Item
            </Link>
            <Link
              href="/item/chicken-wings"
